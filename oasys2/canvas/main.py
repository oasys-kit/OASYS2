...
from orangecanvas.styles import style_sheet, breeze_dark as _breeze_dark
...
from orangecanvas.application.outputview import TextStream, ExceptHook, TerminalTextDocument

from orangecanvas import utils, config
from orangecanvas.gui.splashscreen import SplashScreen
from orangecanvas.gui.utils import macos_set_nswindow_tabbing as _macos_set_nswindow_tabbing
